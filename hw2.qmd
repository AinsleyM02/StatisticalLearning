...
library(caret)
# split the data:
#sample function randomly generates a sample from the data
#floor or ceiling is bring it up or down
split<-sample(1:nrow(data_sim), size=floor(0.8*nrow(data_sim)))
# select all the rows that meet those indexes
train_data<-data_sim[split,]
test_data<-data_sim[-split,]
