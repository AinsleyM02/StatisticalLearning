...
test_perf <- tibble(
  truth = factor(cld_train_s$y, levels = c(0, 1)),  # Ensure this is binary (0 and 1)
...
for (i in 1:n_iterations) {
  ...
  yhat_logreg <- predict(cv_logreg, newx = X_holdout, s = best_lambda, type = "response")
  ...
  auc_logreg[i] <- roc_auc_vec(as.factor(y_holdout), yhat_logreg)
